...
% (at your option) any later version.
    ...
    while(FLAG && i<itmax)
        ...
        if (tryNewton)
            ...
            warning off all;
            [descent3,flag,~,minres_iter] = minres(Hess3,-grad,1E-6,1000,[],[],descent*scaling);
            fprintf('Minres Steps: %d \n', minres_iter);
            warning on all;
...
%             fprintf('Inside Newton descent %d\n',i);
        else
            descent = -grad;
...
%             fprintf('Inside gradient descent step %d\n',i);
        ...
        fprintf('Functional:%.15f, Gradient:%.25f at p=%f \n',currentF,gradNorm,p);

    end
    
    fprintf('Total B&H iters = %d \n',i);
